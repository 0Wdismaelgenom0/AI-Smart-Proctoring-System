...
################################################################################
## Form generated from reading UI file 'login_dbNJSQRL.ui'
##
...
"border:2px solid rgb(0, 255, 255);")
        ...
        self.pt_login.setGeometry(QRect(181, 310, 135, 81))
...
"background-color: qradialgradient(spread:pad, cx:1, cy:1, radius:0.5, fx:1, fy:0.977, stop:1 rgba(170, 41, 47, 0));")
    ...
    def retranslateUi(self, Form):
        ...
        self.log_message.setText(QCoreApplication.translate("Form", u"you don't have permission to log", None))
    # retranslateUi
